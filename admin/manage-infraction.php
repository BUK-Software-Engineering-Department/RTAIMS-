  ...
  <div class="content-wrapper">
    <div class="container" style="margin-top: 10vh;">
      <!-- Content Header (Page header) -->
            ...
            <h4 class="p-3 bg-light text-success text-center rounded">MANAGE INFRACTION RECORD</h4>
            ...
            ?>
                  <tr>
                    ...
                    <td><?php echo "TINTED GLASS "; ?></td>
                    <td><?php echo "N10000.00"; ?></td>
