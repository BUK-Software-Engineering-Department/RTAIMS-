     ...
     <div class="container col-md-8 " style="margin-top: 20vh;">
        <form role="form" action="" method="post" enctype="multipart/form-data">
          <div class="box-body p-3 rounded pd-20 mt-5 card-box mb-30">
            <h4 class="p-3 bg-light text-success text-center rounded">DOCUMENT NEW TRAFFIC ACCIDENT</h4>
              ...
              <form method="post">
                <div class="form-group row mt-5">
                  ...
                  <label for="inputPassword" class="col-sm-2 col-form-label">Injuries and Damage</label>
                  <div class="col-md-10"> 
                    <textarea class="form-control form-control" name="injuries" required></textarea>
                    <small><i>Document any injuries sustained by individuals involved in the accident, including drivers, passengers, and pedestrians. Also, note any damages to vehicles or property.</i></small>
